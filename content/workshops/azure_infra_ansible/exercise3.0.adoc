...
- DISA STIG controls
https://galaxy.ansible.com/redhatofficial/rhel7_disa_stig
...
[source,bash]
----
- downloading role 'rhel7_disa_stig', owned by redhatofficial
- downloading role from https://github.com/RedHatOfficial/ansible-rhel7-disa-stig-role/archive/0.1.41.tar.gz
- extracting redhatofficial.rhel7_disa_stig to /etc/ansible/roles/redhatofficial.rhel7_disa_stig
- redhatofficial.rhel7_disa_stig (0.1.41) was installed successfully
----
