---
title: "Exercise 1.7 - Using Variables, Loops, and Handlers"
...
= Exercise 1.7 - Using Variables, Loops, and Handlers
...
To begin, we are going to create a new playbook, but it should look very familiar to the one you created in exercise 1.5
